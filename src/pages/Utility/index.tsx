                ...
                <div className="NT-Card mt-4">
                    <Row>
                        ...
                        <Col sm="6">
                            ...
                            <p style={{ fontSize: '28px', fontFamily: 'SF Pro Text Heavy', paddingBottom:'20px'}}>1.25 <span style={{ fontSize: '17px', fontFamily: 'SF Pro Text Heavy' }}>USD</span></p>
                        </Col>
                    </Row>
                ...
                <div className="NT-Card mt-4">
                    <Row>
                        ...
                        <Col sm="6">
                            ...
                            <p style={{ fontSize: '28px', fontFamily: 'SF Pro Text Heavy'}}>1,152,875,97 <span style={{ fontSize: '17px', fontFamily: 'SF Pro Text Heavy' }}>NearT</span></p>
                        </Col>
                    </Row>
                </div>
                <div className="NT-Card mt-4">
